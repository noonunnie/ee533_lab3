...
// /___/   /\     Timestamp : 02/02/2026 21:05:15
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/test_project/lab3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_5 (.A(waddr[7:0]), 
                                  .B(raddr[7:0]), 
                                  .EQ(XLXN_10));
   // synthesis attribute HU_SET of XLXI_5 is "XLXI_5_20"
   ...
   OR2 XLXI_34 (.I0(XLXN_28), 
                .I1(XLXN_29), 
                .O(XLXN_30));
   AND2B1 XLXI_35 (.I0(XLXN_31), 
                   .I1(XLXN_30), 
                   .O(XLXN_7));
   AND3B2 XLXI_36 (.I0(XLXN_14), 
                   .I1(XLXN_10), 
                   .I2(fiforead), 
                   .O(XLXN_32));
   VCC XLXI_38 (.P(XLXN_74));
   dual9Bmem XLXI_42 (.addra(waddr[7:0]), 
                      .addrb(raddr[7:0]), 
                      .clka(clk), 
                      .clkb(clk), 
                      .dina(in_fifo0[71:0]), 
